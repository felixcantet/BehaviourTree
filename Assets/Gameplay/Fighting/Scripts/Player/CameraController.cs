...
public class CameraController : MonoBehaviour {
	...
	public void CustomUpdate () {
		...
		this.trueDistance = Physics.Raycast(this.character.position, this.camera.rotation * new Vector3(0, 0, -this.distance),out this.rayHit,this.distance,6) ? Vector3.Distance(this.character.position, this.rayHit.point) : this.distance;
